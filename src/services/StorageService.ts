...
//
// Os buckets são públicos para leitura, então devolvemos a URL pública (estável,
// não expira). Se um dia virarem privados, troca-se getPublicUrl por
// createSignedUrl aqui — o resto do app não muda.
