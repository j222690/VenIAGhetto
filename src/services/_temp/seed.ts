...
import type { GenerationType, ProductSheet, SocialCopySet, LookType } from "@/types";
...
// ---------------------------------------------------------------------------
const PLACEHOLDER_RESULTS: Record<LookType, string> = {
...
export const placeholderResult = (type: GenerationType): string =>
  PLACEHOLDER_RESULTS[type as LookType] ?? PLACEHOLDER_RESULTS.tryon;
